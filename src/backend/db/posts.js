...
export const posts = [
  ...
  {
    _id: uuid(),
    content:"The Ministry of Home Affairs has accorded ‘Y’ Scale of security to Bharatiya Janata Party Tamil Nadu president K. Annamalai. According to police sources, he would be protected round-the-clock by armed Personal Security Officers drawn from the Central Reserve Police Force (CRPF) and the Security Branch CID of the State police.",
    likes: {
      likeCount: 0,
      likedBy: [],
      dislikedBy: [],
  ...
  {
    _id: uuid(),
    content:"Security cover for Mr. Annamalai was enhanced after a detailed assessment of his threat perception. Intelligence agencies gathered the level of threat to the former IPS officer-turned-politician in the recent weeks and prepared a report, the sources said. Last month, petrol-filled bottles, the wick in one of them lit,",
    likes: {
      likeCount: 0,
      likedBy: [],
      dislikedBy: [],
    },
    userPhoto:"https://pbs.twimg.com/profile_images/1426015031360049153/QYd08TfK_200x200.jpg",
    username: "@jsaideepak",
    createdAt: formatDate(),
    updatedAt: formatDate(),
  },
  ...
  },
  {
    ...
    userPhoto:"https://pbs.twimg.com/profile_images/1514922147365330948/qeCXYlZR_200x200.jpg",
    username: "@Iyervval",
    createdAt: formatDate(),
    updatedAt: formatDate(),
  },
